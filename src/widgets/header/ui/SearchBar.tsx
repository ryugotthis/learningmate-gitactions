      ...
      <div className="border-[0.15rem] border-secondary-default p-[0.05rem] rounded-full">
        <div className="border-[0.15rem] border-secondary-default p-[0.05rem] rounded-full">
          <div className="border-[0.15rem] border-secondary-default  rounded-full">
            <div className="relative flex gap-[18px] w-[312px] md:w-[608px] lg:w-[640px] h-[56px] px-[16px] py-[12px] items-center border border-line rounded-4xl bg-surface-dark flex-grow">
              {/* 플랫폼 드롭다운 버튼 */}
                ...
                >
                  ...
                  <ul className=" bg-white ">
                    {filteredSuggestions.length > 0 ? (
                      ...
                      <li
                        onClick={() => createLecture(searchText)}
